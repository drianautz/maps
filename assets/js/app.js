...
(0, _jquery2.default)(function () {
  ...
  banner_height();
  maps();
  (0, _jquery2.default)('.maps__item-wrapper').scrollbar();
  placeholder();
  search();
  reset_class_on_resize();
  search();
  burger_menu();
  same_height();
  placement();
...
// carousel
(0, _jquery2.default)(".testimonial__right-item-wrapper").slick({
  dots: true,
  arrows: false
});

(0, _jquery2.default)(".col__left-inner--news").slick({
  dots: true,
  arrows: true
});

(0, _jquery2.default)(".col__split--home").slick({
  dots: false,
  arrows: false,
  slidesToShow: 3,
  variableWidth: false,
...
// function three_col_carousel() {

// $(".col__split--content").slick({
//   dots: false,
//   arrows: false,
//   slidesToShow: 3,
//   responsive: [{
...
function header_fixed() {
  ...
  if ((0, _jquery2.default)(window).outerWidth() > 1023) {
    (0, _jquery2.default)(window).scroll(function () {
      if ((0, _jquery2.default)(window).scrollTop() >= 90) {
        (0, _jquery2.default)('.nav').addClass("nav--fixed");
        (0, _jquery2.default)('.pages').addClass("has--padding");
      } else {
        (0, _jquery2.default)('.nav').removeClass("nav--fixed");
        (0, _jquery2.default)('.pages').removeClass("has--padding");
      }
    });
  }
}
...
function same_height() {
  if ((0, _jquery2.default)(window).outerWidth() < 640) {
    (0, _jquery2.default)('.col__right').each(function () {
      var highestBox = 0;
      // Select and loop the elements you want to equalise
      (0, _jquery2.default)('.col__right .col__item', this).each(function () {
        // If this box is higher than the cached highest then store it
        if ((0, _jquery2.default)(this).height() > highestBox) {
          highestBox = (0, _jquery2.default)(this).height();
        }
      });
      // Set the height of all those children to whichever was highest 
      (0, _jquery2.default)('.col__right .col__item', this).height(highestBox);
    });
  }
}

function banner_height() {
  if ((0, _jquery2.default)(window).outerWidth() > 639) {
    var left_banner = (0, _jquery2.default)('.col__left-item').height();
    var right_banner = parseFloat((left_banner - 60) / 3);
    (0, _jquery2.default)(".col__right .col__item").css("height", right_banner);
  } else {
    // $(".col__right .col__item").css("height","auto");
  }
}

function footer_offset() {
  if ((0, _jquery2.default)(window).outerWidth() > 1023) {
    var wndw = (0, _jquery2.default)(window).outerWidth();
    var content = (0, _jquery2.default)('.nav__desktop').outerWidth();
    var padding = parseFloat((wndw - content + 15) / 2);
    (0, _jquery2.default)(".footer__col-1").css('padding-left', padding);
    (0, _jquery2.default)(".footer__col-4").css('padding-right', padding);
    (0, _jquery2.default)(".maps__left").css('padding-left', padding);
  } else {
    (0, _jquery2.default)(".footer__col-1").css('padding-left', '15px');
    (0, _jquery2.default)(".footer__col-4").css('padding-right', '15px');
    (0, _jquery2.default)(".maps__left").css('padding-left', '15px');
  }
}

function maps_offset() {
  var wndw = (0, _jquery2.default)(window).outerWidth();
  var content = parseFloat((0, _jquery2.default)('.main__content').outerWidth() - 70);
  var padding = parseFloat((wndw - content) / 2);
  if ((0, _jquery2.default)(window).outerWidth() > 1023) {
    (0, _jquery2.default)(".maps__left").css('padding-left', padding);
  } else {
    (0, _jquery2.default)(".maps__left").css('padding-left', '20px');
  }
}
...
function search() {
  if ((0, _jquery2.default)(window).outerWidth() > 1023) {
    (0, _jquery2.default)('.nav__link--search').click(function (e) {
      e.preventDefault();
      (0, _jquery2.default)('.nav__search').addClass('active');
      (0, _jquery2.default)('.search-close').click(function () {
        e.preventDefault();
        (0, _jquery2.default)('.nav__search').removeClass('active');
        (0, _jquery2.default)('.input--search').val('');
      });
      (0, _jquery2.default)(document).mouseup(function (e) {
        var container = (0, _jquery2.default)(".nav__search");
...
function reset_class_on_resize() {
  if ((0, _jquery2.default)(window).outerWidth() <= 1023) {
    (0, _jquery2.default)('.nav__bar-wrapper').removeClass('change');
  }
  if ((0, _jquery2.default)(window).outerWidth() <= 639) {
    (0, _jquery2.default)('.accordion--content .accordion-item:first-child').removeClass('is-active');
    (0, _jquery2.default)('.accordion--content .accordion-item:first-child .accordion-title').attr({
      ariaExpanded: "false",
      ariaSelected: "false"
    });
    (0, _jquery2.default)('.accordion--content .accordion-item:first-child .accordion-content').removeClass('is-active').css('display', 'none').attr('ariaHidden', 'true');
  } else {
    (0, _jquery2.default)('.accordion--content .accordion-item:first-child').addClass('is-active');
    (0, _jquery2.default)('.accordion--content .accordion-item:first-child .accordion-title').attr({
      ariaExpanded: "true",
      ariaSelected: "true"
    });
    (0, _jquery2.default)('.accordion--content .accordion-item:first-child .accordion-content').addClass('is-active').css('display', 'block').attr('ariaHidden', 'false');
  }
}

function burger_menu() {
  (0, _jquery2.default)('.nav__bar-wrapper').click(function () {
    if ((0, _jquery2.default)('.nav__main').css('display') == 'none') {
      (0, _jquery2.default)(this).removeClass('change');
    } else {
      (0, _jquery2.default)(this).addClass('change');
    }
  });
}
...
function placement() {
  //three-col
  if ((0, _jquery2.default)(window).outerWidth() <= 639) {
    (0, _jquery2.default)('.three-col__wrapper').insertAfter((0, _jquery2.default)(".avatar__wrapper--bottom"));
  } else {
    (0, _jquery2.default)('.three-col__wrapper').insertAfter((0, _jquery2.default)('.main__content'));
  }

  //accordion-sidebar
  if ((0, _jquery2.default)(window).outerWidth() <= 639) {

    (0, _jquery2.default)('.accordion-content--mobile').append((0, _jquery2.default)('.accordion--sidebar'));

    if ((0, _jquery2.default)('body').hasClass('contact-us') || (0, _jquery2.default)('body').hasClass('incentives-for-employers')) {
      (0, _jquery2.default)('.mobile__wrapper').append((0, _jquery2.default)('.accordion--mobile, .sidebar__share'));
    }
    // } else {
    //   $('.accordion--sidebar').insertBefore($('.sidebar__contact'));
    //   $('.sidebar__contact').insertBefore($('.sidebar__share'));
    // }
    // else {
    // $('.accordion--mobile, .sidebar__share').insertBefore($('.sidebar__contact'));
    // $('.main__sidebar').append($('.accordion--mobile, .sidebar__share'));
    // }
  } else {
    if ((0, _jquery2.default)('body').hasClass('contact-us') || (0, _jquery2.default)('body').hasClass('incentives-for-employers')) {
      (0, _jquery2.default)('.main__sidebar').append((0, _jquery2.default)('.accordion--sidebar, .sidebar__share'));
      // $('.accordion--sidebar, .sidebar__share ').insertBefore($('.sidebar__contact'));
    }
    // $('.main__sidebar').append($('.accordion--sidebar, .sidebar__contact, .sidebar__share'));
    (0, _jquery2.default)('.accordion--sidebar').insertBefore((0, _jquery2.default)('.sidebar__contact'));
    (0, _jquery2.default)('.sidebar__contact').insertBefore((0, _jquery2.default)('.sidebar__share'));
  }

  //filter-sidebar
  if ((0, _jquery2.default)(window).outerWidth() <= 639) {
    (0, _jquery2.default)('.accordion-content--filter').append((0, _jquery2.default)('.sidebar__filter, .sidebar__categories'));
  } else {
    (0, _jquery2.default)('.sidebar__filter, .sidebar__categories').insertBefore((0, _jquery2.default)('.sidebar__box-wrapper'));
  }

  //info-sidebar
  if ((0, _jquery2.default)(window).outerWidth() <= 639) {
    (0, _jquery2.default)('.info__mobile').append((0, _jquery2.default)('.sidebar__info'));
  } else {
    (0, _jquery2.default)('.sidebar__info').insertBefore((0, _jquery2.default)('.sidebar__share'));
  }

  //sidebar-categories
  if ((0, _jquery2.default)(window).outerWidth() <= 639) {
    (0, _jquery2.default)('.sidebar__news').insertAfter((0, _jquery2.default)('.hero__title'));
  } else {

    // $('.main__sidebar').append($('.sidebar__news, .sidebar__categories, .sidebar__box-wrapper'));
    (0, _jquery2.default)('.sidebar__news').insertBefore((0, _jquery2.default)('.sidebar__categories'));
  }
}

function arrow_class() {
  if ((0, _jquery2.default)(window).outerWidth() <= 1023) {
    (0, _jquery2.default)('.nav i._icon--arrow').removeClass('_icon--arrow-desktop').addClass('_icon--arrow-mobile');
  } else {
    (0, _jquery2.default)('.nav i._icon--arrow').removeClass('_icon--arrow-mobile').addClass('_icon--arrow-desktop');
  }
}
...
//     $('.col__split--home').addClass('col__split--home-slider');
//   }
//   else {
//     $('.col__split--home').removeClass('col__split--home-slider');
//   }
// }
